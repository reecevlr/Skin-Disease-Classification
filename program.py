...
RETINANET = os.path.abspath("./model/Retinanet_alpha_025_gamma_1.pth")
OCLBP = os.path.abspath("./model/OCLBP_2_12.pth")
LBPRETINA = os.path.abspath("./model/StandardLBP_3_12.pth")
...
def checkImage(img, option):
	...
	if option == "LBP-Retina":
		...
		lbp_image = lbp_color.runLBPColor(img)
